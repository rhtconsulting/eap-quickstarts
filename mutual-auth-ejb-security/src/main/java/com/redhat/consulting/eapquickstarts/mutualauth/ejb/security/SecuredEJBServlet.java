 ...
 */
package com.redhat.consulting.eapquickstarts.mutualauth.ejb.security;
...
@ServletSecurity(@HttpConstraint(rolesAllowed = "ejbuser", transportGuarantee = ServletSecurity.TransportGuarantee.CONFIDENTIAL))
public class SecuredEJBServlet extends HttpServlet {

	private static String PAGE_HEADER = "<html><head><title>mutual-auth-ejb-security</title></head><body>";
